...
if __name__ == '__main__':
    ...
    # Nombre d'itération et initialisation
    ...
    if rank == 0:
        ...
        #while loop :
        while iteration_aff < Nbre_iteration:
        ...
        #loop = True
        #while loop :
        while iteration_calc < Nbre_iteration:
    ...
    # Affichage des temps moyen d'affichage et de calcul
    print("Temps Moyen d'affichage:", Temps_aff / Nbre_iteration)
    print("Temps Moyen de calcul:", Temps_calc / Nbre_iteration)
