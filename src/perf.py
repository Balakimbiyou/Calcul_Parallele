...
class Grille:
    ...
    def __init__(self, rank: int, nbp: int, dim, init_pattern=None, color_life=pg.Color("black"),
    ...
    def compute_next_iteration(self):
        ...
        neighbours_count = sum(
            np.roll(np.roll(self.cells, i, 0), j, 1) for i in (-1, 0, 1) for j in (-1, 0, 1) if (i != 0 or j != 0))
    ...
    def update_ghost_cells(self):
        """
        Met à jour les cellules fantômes. Pas comme pour les lignes. Les envois et réception nécessitent des arrays contigus ce qui n'est pas le cas des colonnes.
        Utilisation d'array temp en attendant. A optimiser.
        """
...
if __name__ == '__main__':
    ...
    dico_patterns = {  # Dimension et pattern dans un tuple
        ...
        "pulsar": ((17, 17),
                   [(2, 4), (2, 5), (2, 6), (7, 4), (7, 5), (7, 6), (9, 4), (9, 5), (9, 6), (14, 4), (14, 5), (14, 6),
                    ...
                    (11, 14), (12, 14)]),
        "floraison": ((40, 40),
                      [(19, 18), (19, 19), (19, 20), (20, 17), (20, 19), (20, 21), (21, 18), (21, 19), (21, 20)]),
    ...
    if rank == 0:
        ...
        while loop and iteration_aff < Nbre_iteration:
            ...
            # Ajout du temps du nouveau temps d'affichage
            Temps_aff += t3 - t2
            iteration_aff += 1
        ...
        loop = True
        while loop and iteration_calc < Nbre_iteration:
            ...
            diff_send = []
            if diff[0].shape != (0,):
                diff_send = rows * grid.dimensions[
                    1] + cols + grid.start_loc - 1  # décalage en colonne comme on parallelise en colonne
            grid.update_ghost_cells()
            t2 = time.time()

            diff_glob = newCom.gather(diff_send, root=0)  # sérialiser réfléchir à une optimisation
            if newCom.rank == 0:
                diff_index = [x for xs in diff_glob for x in
                              xs]  # Rassemblement des indices à modifier par proc en une seule liste
    ...
    Temps_aff = Temps_aff / Nbre_iteration
    Temps_calc = Temps_calc / Nbre_iteration

    print(f"Temps affichage Moyen: {Temps_aff}")
    print(f"Temps calcul Moyen: {Temps_calc}")
